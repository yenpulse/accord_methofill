    ...
    toggleReferences: function() {
      ...
      if (overlay && referencesToggle) {
        if (referencesState) {
          ...
          overlay.open(`<img class="popup-background" src="modules/ag-menu/assets/overlay-references.jpg" alt="...">`);
...
app.register("S09_Subcutaneous_Route_003", function () {
  return {
    ...
    toggleOverlay: function (event) {
      ...
      if (overlay)
        overlay.open(
          `<img class="popup-background" src="slides/S09_Subcutaneous_Route_003/assets/${overlayId}.jpg" alt="...">`
        );
    },
  };
});
...
app.register("S20_Good_Use_003", function() {
...
app.register("S24_Good_Use_007", function() {
